...
public class Flameshot : MonoBehaviour
{
    ...
    //public GameObject Flambertes;

    void Start()
    {
        // Look for the player in the scene and store a reference to its transform
       // Flambertes = GameObject.Find("Flamber");
       // animator = Flambertes.GetComponent<Animator>();
    }
    void Update()
    {
